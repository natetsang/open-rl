"""
AC using shared NN model.
This is almost identical to VPG except we're using a bootstrapped
estimate of the rewards-to-go instead of a MC estimate!
"""
import gym
import time
import argparse
...
from util.compute_returns import compute_bootstrapped_returns
    ...
    def train_episode(self) -> dict:
        with tf.GradientTape() as tape:
            ...
            for i in range(self.batch_size):
                ...
                # Calculate rewards
                returns = compute_bootstrapped_returns(rewards=reward_trajectory, values=value_trajectory, gamma=GAMMA)
