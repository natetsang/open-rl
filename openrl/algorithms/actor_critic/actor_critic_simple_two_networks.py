"""
1-step actor-critic using two NN models.

* This doesn't work very well, which is expected per Sergey Levine in his AC lecture in CS285
"""
import gym
import time
import argparse
    ...
    def train_episode(self) -> dict:
        ...
        while not done:
            ...
            with tf.GradientTape() as actor_tape, tf.GradientTape() as critic_tape:
                ...
                # Calculate losses
                # TODO >> Do we need to reduce these?
        ...
        logs['ep_total_loss'] = tf.reduce_mean(actor_loss)  # I'm not 100% sure this is correct
        return logs
