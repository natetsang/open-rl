"""
REINFORCE - some superfluous details that we need when we transition from reinforce to actor critic
"""
import gym
import time
import argparse
    ...
    def train_episode(self) -> dict:
        ...
        while not done:
            ...
            with tf.GradientTape() as tape:
                ...
                # sum the entire rewards for the trajectory instead
